...
python tools/transform_json2txt_mc_aerial.py --source_path data/matrix_city/aerial/train/block_all --intrinsic_path data/matrix_city/aerial/pose/block_all/transforms_train.json
python tools/transform_json2txt_mc_aerial.py --source_path data/matrix_city/aerial/test/block_all_test --intrinsic_path data/matrix_city/aerial/pose/block_all/transforms_test.json
